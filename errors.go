...
func genErrorsReason(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, enum *protogen.Enum) bool {
	...
	// custom
	ew.EnumName = string(enum.Desc.Name())
	ew.DefaultCode = code
	executeCustom(gen, file, &ew)

	return false
}

func executeCustom(gen *protogen.Plugin, file *protogen.File, ew *errorWrapper) {
	filename := file.GeneratedFilenamePrefix + "_errors_custom.pb.go"
	g := gen.NewGeneratedFile(filename, file.GoImportPath)
	g.P("// Code generated by protoc-gen-go-errors. DO NOT EDIT.")
	g.P()
	g.P("package ", file.GoPackageName)
